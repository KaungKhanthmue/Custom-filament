<x-filament-panels::page class="2xl:w-[1880px] xl:w-[1250px] lg:w-[1100px]">
    <!-- component -->
    <div class="relative w-full mx-auto my-3 dark:bg-gray-800 p-4 rounded-md">
        <!-- top navbar -->
        ...
        <div class="grid grid-cols-4">
            <button class="mx-auto">
                <svg xmlns="http://www.w3.org/2000/svg" class="border-b-2 border-gray-600 h-6 w-6" fill="none"
        ...
        <!-- bottom navigation -->
        <div class="sticky bottom-0 left-0 bg-white w-full py-2 px-3 mt-1 text-xs dark:bg-black">
